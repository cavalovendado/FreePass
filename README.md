# Free Pass - Bilhete Digital Escolar

## Integrantes
- Amanda Rosa de Carvalho  
- Ana Lívia da Silva Berchon Pavanatto
...
## Funcionalidades
- [x] Cadastrar alunos e responsáveis  
...
2. Adicionar este README no repositório.  
4. Teste do código no Portugol Studio 

## Roteiro de Desenvolvimento
1. Revisar a situação-problema e identificar entradas, saídas e regras.  
2. Criar o menu principal:
   - 1. Cadastrar bilhete  
   - 2. Listar bilhetes  
   - 3. Confirmar saída  
   - 4. Sair  
3. Definir o uso de **vetor** e **matriz**.  
...
- Adicionar **autenticação de usuários** (login da secretaria e de pais).  
- Salvar dados em **arquivo externo** para persistência.  
